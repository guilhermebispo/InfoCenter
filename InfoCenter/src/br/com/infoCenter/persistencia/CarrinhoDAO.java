...
public class CarrinhoDAO {
	...
	public boolean incluirCarrinho(CarrinhoDTO carrinhoDTO) {
		...
		try {
			...
			e.printStackTrace();// pilha de erro
			return false;
		}
	}

	public int getQtdProduto(CarrinhoDTO carrinhoDTO) {
		Connection conn = Conexao.getConexao();
		PreparedStatement ps;
		try {
	...
	public List<ProdutoDTO> getProdutos(long idUsuario) {
		Connection conn = Conexao.getConexao();
	...
	public boolean apagarCarrinho(CarrinhoDTO carrinhoDTO) {
		Connection conn = Conexao.getConexao();
		try {
			int qtd_produto = getQtdProduto(carrinhoDTO);
			PreparedStatement ps;
	...
	public double getTotalCompra(long idCliente) {
		Connection conn = Conexao.getConexao();
		try {
			PreparedStatement ps = (PreparedStatement) conn
